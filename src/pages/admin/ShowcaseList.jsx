// src/pages/admin/ShowcaseList.jsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';

const dummyShowcase = [
  { id: 1, title: '수원 화성 나들이 후기', date: '2026.04.10', status: '접수 중' },
  { id: 2, title: '판교 맛집 탐방기', date: '2026.03.30', status: '접수 중' },
  { id: 3, title: '가평 캠핑 후기', date: '2025.11.20', status: '접수 완료' },
];
...
const ShowcaseList = () => {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">뽐낼거리 관리</h1>
      <div className="bg-white rounded-2xl shadow-sm p-6">
          ...
          <tbody>
            {dummyShowcase.map((r) => (
              <tr
                ...
                onClick={() => navigate(`/admin1/showcase/${r.id}`)}
              >
        ...
        <div className="flex justify-end gap-2 mt-4">
          <button className="px-4 py-2 border border-gray-300 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition">입력하기</button>
          <button className="px-4 py-2 border border-gray-300 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition">서목</button>
        </div>
